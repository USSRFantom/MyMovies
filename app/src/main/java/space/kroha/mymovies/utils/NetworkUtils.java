...
public class NetworkUtils {
    ...
    private static final String BASE_URL_REVIEWS = "https://api.themoviedb.org/3/movie/%s/rewiews";

    private static final String API_KEY = "ae0626cfdbab150eddb9954348ac9aad";
    ...
    public static class JSONLoader extends AsyncTaskLoader<JSONObject> {
        ...
        protected void onStartLoading() {
            ...
            if(onStartLoadingListener != null){
                onStartLoadingListener.onStarLoading();
            }
            forceLoad();;
        }
